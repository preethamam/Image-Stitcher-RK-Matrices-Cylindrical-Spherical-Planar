...
for i = 1:length(transformationtype)
    ...
    nexttile; imshow(panorama{1}); title([transTitle ' ' warpType{1}], 'fontsize', 15)        
    nexttile; imshow(croppedPanorama{1}); title([transTitle ' ' warpType{1} ' ' 'cropped'], 'fontsize', 15)

    nexttile; imshow(panorama{2}); title([transTitle ' ' warpType{2}], 'fontsize', 15)     
    nexttile; imshow(croppedPanorama{2}); title([transTitle ' ' warpType{2} ' ' 'cropped'], 'fontsize', 15)

    nexttile; imshow(panorama{3}); title([transTitle ' ' warpType{3}], 'fontsize', 15)
    nexttile; imshow(croppedPanorama{3}); title([transTitle ' ' warpType{3} ' ' 'cropped'], 'fontsize', 15)
